...
Constructor, returns a vector from a list of terms given as string, with a delimitator between each of them (default delimitator: ','). 
...
Construct the vector from a string i.e. 

: \hyperlink{classgrassmann_1_1Vector}{Vector} v = \char`\"{}2,3,4\char`\"{}; \begin{Desc}
\item[Parameters:]
\begin{description}
\item[{\em s}]String containing the elements of the vector (warning: you must use ',' as delimiter between the terms) \end{description}
\end{Desc}
